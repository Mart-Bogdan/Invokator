...
namespace SUF.Common.GeneralPurpose
{
    ...
    {
        static readonly Dictionary<MyTuple<MethodInfo, bool>, Invokation> cache = new Dictionary<MyTuple<MethodInfo, bool>, Invokation>();
        ...
        public static Invokation GetInvokator(this MethodInfo methodInfo, bool invokeVirtual)
        {
            ...
            {
                Invokation fun;
                var methodKey = new MyTuple<MethodInfo, bool>(methodInfo, invokeVirtual);
